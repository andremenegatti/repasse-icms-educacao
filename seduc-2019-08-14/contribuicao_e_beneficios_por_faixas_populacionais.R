...
df2 %>% 
  ...
  ggtitle('Contribuição de municípios de diferentes tamanhos para o total redistribuído',
          subtitle = 'Valor adic. (75%), Educ. (18,5%), Receitas Correntes Líq. (6%), Área Inundada (0,5%)') +
