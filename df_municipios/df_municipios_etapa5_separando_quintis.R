...
#### ABRINDO BASES ####
df_municipios <- readRDS('Dados/df_municipios_etapa4.rds')
...
df_quintis_variaveis_classificacao <- df_municipios %>% 
  select(municipio, pop, pop_urbana, idosos_sobre_jovens, fracao_pop_abaixo_15,
         area_geografica, IDH, area_cultivada, receitas_correntes_2018, receitas_correntes_2018,
...
#### SALVANDO ####
saveRDS(df_municipios, 'Dados/df_municipios_etapa5.rds')
source("salvar_tabela.R")
salvar_tabela(df_municipios, file = "Dados/df_municipios_etapa5.csv")
